...
import { PRIVACY_POLICY } from '@/utils/routes';
    ...
    <Layout>
      <div className={style.container}>
        ...
        <p>
          ...
          bound by all of these Terms and Conditions. If you do not agree with all of these
          Terms and Conditions, then you are expressly prohibited from using the Site and you
        ...
        <p>
          Accordingly, those persons who choose to access the Site from other locations do so
        ...
        <p>
          ...
          personal use only. Except as expressly provided in these Terms and Conditions, no
        ...
        <p>
          ...
          commercial use. We reserve all rights not expressly granted to you in and to the Site,
        ...
        <p>
          ...
          websites. As such, any Contributions you transmit may be treated as non-
          confidential and non-proprietary. When you create or make available any
        ...
        <p>
          You are solely responsible for your Contributions to the Site and you expressly agree
        ...
        <ol>
          ...
          <li>
            your reviews should not contain offensive profanity, or abusive, racist, offensive,
            or hate language;
          </li>
          <li>
        ...
        <p>
          ...
          and license to reproduce, modify, translate, transmit by any means, display, perform,
          and/or distribute all content relating to reviews.
        </p>
        <h2>Mobile Application Lecense</h2>
        <h4>Use License</h4>
        <p>
        ...
        <ol>
          <li>
            the license granted to you for our mobile application is limited to a non-
            ...
            forth in the applicable App Distributor’s terms and conditions;
          </li>
          <li>
            ...
            mobile application license contained in these Terms and Conditions or as otherwise
          ...
          <li>
            ...
            for the mobile application, and to the maximum extent permitted by applicable law,
            the App Distributor will have no other warranty obligation whatsoever with respect
          ...
          <li>
            ...
            mobile application, e.g., if you have a VoIP application, then you must not be in
            violation of their wireless data service agreement when using the mobile application;
          </li>
          <li>
            you acknowledge and agree that the App Distributors are third-party beneficiaries
            of the terms and conditions in this mobile application license contained in these
            Terms and Conditions, and that each App Distributor will have the right (and will be
            deemed to have accepted the right) to enforce the terms and conditions in this
            mobile application license contained in these Terms and Conditions against you as a
        ...
        <p>
          ...
          access, make available, and store (if applicable) any content that you have provided
        ...
        <p>
          ...
          or our access to such Third-Party Account is terminated by the third-party service
          provider, then Social Network Content may no longer be available on and through
          the Site. You will have the ability to disable the connection between your account on
        ...
        <p>
          We make no effort to review any Social Network Content for any purpose, including
        ...
        <p>
          ...
          contacting us using the contact information below or through your account settings
          (if applicable). We will attempt to delete any information stored on our servers that
        ...
        <p>
          ...
          we take no responsibility whatsoever in relation to such purchases which are
        ...
        <p>
          ...
          certain areas of the Site, such as sidebar advertisements or banner advertisements. If
          you are an advertiser, you shall take full responsibility for any advertisements you
          place on the Site and any services provided on the Site or products sold through
        ...
        <ol>
          ...
          <li>
            ...
            the law or these Terms and Conditions, including without limitation, reporting such
          ...
          <li>
            in our sole discretion and without limitation, notice, or liability, to remove from
            the Site or otherwise disable all files and content that are excessive in size or are in
        ...
        <p>
          ...
          our <Link href={PRIVACY_POLICY}><a>Privacy Policy</a></Link>.
          By using the Site, you agree to be bound by our Privacy Policy, which is
          incorporated into these Terms and Conditions. Please be advised the Site is hosted in
          the United States.
        </p>
        <p>
          ...
          you expressly consent to have your data transferred to and processed in the United
          States.
        </p>
        <p>
          Further, we do not knowingly accept, request, or solicit information from children or
          knowingly market to children. Therefore, if we receive actual knowledge that anyone
          under the age of 13 has provided personal information to us without the requisite
        ...
        <ol>
          ...
          <li>
            ...
            such as an address, telephone number, and, if available, an email address at which
        ...
        <ol>
          <li>
            identification of the material that has been removed or disabled and the location
          ...
          <li>
            ...
            which your address is located, or if your address is outside the United States, for any
        ...
        <p>
          ...
          Site. Without limiting any other provision of these terms and conditions, we reserve
          the right to, in our sole discretion and without notice or liability, deny access to and
          use of the site (including blocking certain ip addresses), to any person for any reason or
          for no reason, including without limitation for breach of any representation, warranty, or
          covenant contained in these terms and conditions or of any applicable law or regulation. we
          may terminate your use or participation in the site or delete your account and any content
        ...
        <p>
          ...
          we have no liability whatsoever for any loss, damage, or inconvenience caused by
          your inability to access or use the Site during any downtime or discontinuance of the
          Site.
        </p>
        <p>
          Nothing in these Terms and Conditions will be construed to obligate us to maintain
          and support the Site or to supply any corrections, updates, or releases in connection
          therewith.
        </p>
        <h2>Governing law</h2>
        <p>
          These Terms and Conditions and your use of the Site are governed by and construed
          in accordance with the laws of Singapore applicable to agreements made and to be
          entirely performed within Singapore, without regard to its conflict of law principles.
        </p>
        ...
        <p>
          ...
          Disputes expressly provided below) informally for at least 100 days before initiating
        ...
        <p>
          ...
          inaccuracies, or omissions that may relate to the Site, including descriptions, pricing,
        ...
        <p>
          ...
          of the site and our services will be at your sole risk. To the fullest extent permitted by
          law, we disclaim all warranties, express or implied, in connection with the site and your
          use thereof, including, without limitation, the implied warranties of merchantability, fitness
          ...
          to or from the site, (5) any bugs, viruses, trojan horses, or the like which may be transmitted
          ...
          in any banner or other advertising, and we will not be a party to or in any way be responsible
        ...
        <p>
          ...
          whatsoever and regardless of the form of the action, will at all times be limited to the lesser of
          the amount paid, if any, by you to us during the 6 month period prior to any cause of action arising or $200.
        </p>
        ...
        <p>
          ...
          (1) your Contributions; (2) use of the Site; (3) breach of these Terms and Conditions;
          (4) any breach of your representations and warranties set forth in these Terms and
          Conditions; (5) your violation of the rights of a third party, including but not limited
          to intellectual property rights; or (6) any overt harmful act toward any other user of
        ...
        <p>
          ...
          perform regular routine backups of data, you are solely responsible for all data that
        ...
        <p>
          ...
          data, and you hereby waive any right of action against us arising from any such loss
        ...
        <p>
          ...
          failure to exercise or enforce any right or provision of these Terms and Conditions
          shall not operate as a waiver of such right or provision.
        </p>
        <p>
          These Terms and Conditions operate to the fullest extent permissible by law. We
        ...
        <p>
          If any provision or part of a provision of these Terms and Conditions is determined to
          be unlawful, void, or unenforceable, that provision or part of the provision is deemed
